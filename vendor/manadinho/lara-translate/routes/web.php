...
use Manadinho\LaraTranslate\Http\Controllers\TranslationControllerAPI;
...
Route::group(['prefix' => config('laraTranslate.uri_start'), 'as' => 'lara-translate.', 'middleware' => config('laraTranslate.middlewares')], function(){
    ...
    Route::group(['prefix' => 'api', 'as' => 'api.'], function(){
        Route::get('/{lang}/index', [TranslationControllerAPI::class,'translationIndex'])->name('index');
        Route::post('/update', [TranslationControllerAPI::class,'updateTranslation'])->name('update');
        Route::post('/translate', [TranslationControllerAPI::class,'translate'])->name('translate');
        Route::get('/{lang}/create', [TranslationControllerAPI::class,'createTranslation'])->name('create');
        Route::post('/translations/store', [TranslationControllerAPI::class,'storeTranslation'])->name('store');
        Route::post('/delete', [TranslationControllerAPI::class,'delete'])->name('delete');
    });
});